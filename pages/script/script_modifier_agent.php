...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['id']) && isset($_POST['nouveau_nom']) && isset($_POST['nouveau_prenom']) && isset($_POST['nouveau_role'])) {
    try {
        ...
        $sql = "UPDATE agent SET nom = :nouveau_nom, prenom = :nouveau_prenom, role = :nouveau_role WHERE id = :id";
